...
public enum CedarEnvironmentVariable {
  ...
  ROR_API_PREFIX("ROR_API_PREFIX"),
  ORCID_API_PREFIX("ORCID_API_PREFIX"),
  ORCID_API_CLIENT_ID("ORCID_API_CLIENT_ID"),
  ORCID_API_CLIENT_SECRET("ORCID_API_CLIENT_SECRET", CedarEnvironmentVariableSecure.YES),
